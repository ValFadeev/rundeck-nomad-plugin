...
import static io.github.valfadeev.rundeck_nomad_plugin.driver.docker.DockerConfigOptions.DOCKER_FORCE_PULL;
import static io.github.valfadeev.rundeck_nomad_plugin.driver.docker.DockerConfigOptions.DOCKER_IMAGE;
import static io.github.valfadeev.rundeck_nomad_plugin.driver.docker.DockerConfigOptions.DOCKER_LOAD;
import static io.github.valfadeev.rundeck_nomad_plugin.driver.docker.DockerConfigOptions.DOCKER_SERVER_ADDRESS;
import static io.github.valfadeev.rundeck_nomad_plugin.driver.docker.DockerConfigOptions.DOCKER_USERNAME;
import static io.github.valfadeev.rundeck_nomad_plugin.nomad.NomadConfigOptions.NOMAD_DATACENTER;
import static io.github.valfadeev.rundeck_nomad_plugin.nomad.NomadConfigOptions.NOMAD_REGION;
